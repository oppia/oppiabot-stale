...
describe('stale', () => {
  ...
  test('removes the stale label and ignores if it has already been removed', async () => {
    let stale = new Stale(github, {
      perform: true,
      owner: 'probot',
      repo: 'stale',
      logger: app.log,
  ...
  test('should not close issues if daysUntilClose is configured as false', async () => {
    let stale = new Stale(github, {
      perform: true,
      owner: 'probot',
      repo: 'stale',
  ...
  test(
    'should not close issues if the keyword pulls or keyword issues is ' +
      'used, and daysUntilClose is configured as false',
    async () => {
      let stale = new Stale(github, {
        perform: true,
        owner: 'probot',
  ...
  test('should not close issues if only keyword is configured with the pulls value', async () => {
    let stale = new Stale(github, {
      perform: true,
      owner: 'probot',
      repo: 'stale',
  ...
  test('should not close pull requests if only keyword is configured with the issues value', async () => {
    let stale = new Stale(github, {
      perform: true,
      owner: 'probot',
      repo: 'stale',
  ...
  describe('mark', () => {
    test('should not mark issue if it is already closed', async () => {
      let stale = new Stale(github, {
        perform: true,
        owner: 'probot',
        repo: 'stale',
    ...
    test('should not mark issue if it is locked', async () => {
      let stale = new Stale(github, {
        perform: true,
        owner: 'probot',
        repo: 'stale',
      ...
      stale.getStale = jest.fn().mockImplementation(() => {
        return Promise.resolve({
          data: {
            items: [{ number: 1, state: 'open', locked: true }],
          },
        });
      });
      stale.markIssue = jest.fn();
    ...
    test('should mark issue if it is open', async () => {
      let stale = new Stale(github, {
        perform: true,
        owner: 'probot',
        repo: 'stale',
  ...
  describe('sweep', () => {
    test('should not close issue if it is already closed', async () => {
      const staleLabel = 'stale';
      let stale = new Stale(github, {
        perform: true,
        owner: 'probot',
    ...
    test('should not close issue if it is locked', async () => {
      const staleLabel = 'stale';
      let stale = new Stale(github, {
        perform: true,
        owner: 'probot',
    ...
    test('should close issue if it is open', async () => {
      const staleLabel = 'stale';
      let stale = new Stale(github, {
        perform: true,
        owner: 'probot',
